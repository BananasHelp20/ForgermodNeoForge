...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> RUBY_END_ORE = createSimpleBlock("ruby_end_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> RUBY_NETHER_ORE = createSimpleBlock("ruby_nether_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> RUBY_STONE_ORE = createSimpleBlock("ruby_stone_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> RUBY_DEEPSLATE_ORE = createSimpleBlock("ruby_deepslate_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> RUBY_OBSIDIAN_ORE = createSimpleBlock("ruby_obsidian_ore",30f, 10, SoundType.CALCITE);

    public static final DeferredBlock<Block> AMETHYST_END_ORE = createSimpleBlock("amethyst_end_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> AMETHYST_NETHER_ORE = createSimpleBlock("amethyst_nether_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> AMETHYST_STONE_ORE = createSimpleBlock("amethyst_stone_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> AMETHYST_DEEPSLATE_ORE = createSimpleBlock("amethyst_deepslate_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> AMETHYST_OBSIDIAN_ORE = createSimpleBlock("amethyst_obsidian_ore",30f, 10, SoundType.CALCITE);

    public static final DeferredBlock<Block> AMBER_END_ORE = createSimpleBlock("amber_end_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> AMBER_NETHER_ORE = createSimpleBlock("amber_nether_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> AMBER_STONE_ORE = createSimpleBlock("amber_stone_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> AMBER_DEEPSLATE_ORE = createSimpleBlock("amber_deepslate_ore",30f, 10, SoundType.CALCITE);
    public static final DeferredBlock<Block> AMBER_OBSIDIAN_ORE = createSimpleBlock("amber_obsidian_ore",30f, 10, SoundType.CALCITE);

...
public class ModBiomeModifiers {
    public static final ResourceKey<BiomeModifier> ADD_OVERWORLD_JADE_ORE = registerKey("add_overworld_jade_ore");
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_OVERWORLD_JADE_ORE, new BiomeModifiers.AddFeaturesBiomeModifier(
                ...
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.OVERWORLD_JADE_ORE_PLACED_KEY)),

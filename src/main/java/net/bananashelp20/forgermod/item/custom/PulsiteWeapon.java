...
public class PulsiteWeapon extends SwordItemWithEffect {
    ...
    public PulsiteWeapon(String gemstone) {
        super(ModToolTiers.PULSITE, ((gemstone.equals("amber") ? pProperties.fireResistant() : pProperties).attributes(SwordItem.createAttributes(ModToolTiers.LUSH, (gemstone.equals("ruby")) ? 5 : 4, (gemstone.equals("amethyst")) ? -2.4f : -2.8f))));

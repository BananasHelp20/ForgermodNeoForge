package net.bananashelp20.forgermod.registryInterpreter.registries.interpretedObjects.blocks.special;

import net.bananashelp20.forgermod.registryInterpreter.registries.interpretedObjects.blocks.InterpretedBlock;

import java.util.ArrayList;
import java.util.Arrays;

public class InterpretedSimpleBlock extends InterpretedBlock {
    public static ArrayList<String> blockProperties;
    public InterpretedSimpleBlock(String name, String properties, String dropMethod, String dropsItem, String modelMethod, String toolTag, String typeTag, String creativeTab) {
    ...
    public String toString() {
        return "    public static final DeferredBlock<Block> " + blockProperties.get(0).toUpperCase() + " = createSimpleBlock(\"" + blockProperties.get(0).toLowerCase() + "\"," + blockProperties.get(1) + ");";
    }
    ...
    public String getBlockState() {
        return "        " + blockProperties.get(4) + "(ModBlocks." + blockProperties.get(0).toUpperCase() + ");";
    }
